...
import { ocrApi } from "@features/transaction/api/ocrApi";
import {
    ArrowLeft,
    Camera,
    Upload,
...
export function CreateTransactionModal({
    ...
    const handleReceiptUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const response = await ocrApi.analyze(file) as { data?: { storeInfo?: string; price?: number; date?: string } };
            ...
            setOcrError((error as { message?: string }).message || "영수증 인식에 실패했습니다.");
        } finally {
            setOcrLoading(false);
