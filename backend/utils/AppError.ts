...
class AppError extends Error {
  ...
  static badRequest(message: string = "잘못된 요청입니다."): AppError {
  ...
  static notFound(message: string = "리소스를 찾을 수 없습니다."): AppError {
    return new AppError(message, 404);
  }

  static internal(message: string = "서버 에러가 발생했습니다."): AppError {
